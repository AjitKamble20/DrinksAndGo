...
{
    public class DrinkMockRepository : IDrinkRepository
    {
        private readonly ICategoryRepository _categoryRepository = new CategoryMockRepository();
            ...
            get
            {
                return new List<Drink>
                {
                    new Drink {
                        ...
                        ImageThumbnailUrl = "https://www.w3schools.com/w3images/fjords.jpg"
                    },
                    new Drink {
                        Name = "Rum & Coke",
